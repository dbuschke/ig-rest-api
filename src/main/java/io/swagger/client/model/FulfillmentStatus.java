...
public class FulfillmentStatus {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.accountId, fulfillmentStatus.accountId) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(accountId, accountName, actualFulfillerId, actualFulfillerLink, actualFulfillerName, appId, appName, assignedUsers, broleId, broleName, certPolicyDescription, certPolicyId, certPolicyName, changeItemAction, changeItemId, changeItemSource, changeRequestItemDate, changeRequestType, changeType, changesetId, childFulfillmentStatusItems, childFulfillmentStatusItemsSkipped, comment, dataPolicyCriteria, dataPolicyDescription, dataPolicyId, dataPolicyName, extraInfo, fallBackReason, flowdata, fulfillerDeleted, fulfillerId, fulfillerName, fulfillerType, fulfillmentId, fulfillmentInstructions, fulfillmentStatus, linkAccount, linkApplication, linkFulfiller, linkHistory, linkPermission, linkUser, objectType, permId, permName, permissionDeleted, processId, reason, reasonId, reasonName, relationToUserType, remediationRunId, requesterName, reviewName, scriptId, scriptName, sourceName, statusDate, troleId, troleName, userDeleted, userId, userName, userUniqueId, values);
  }
