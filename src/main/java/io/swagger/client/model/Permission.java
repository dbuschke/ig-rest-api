...
import io.swagger.client.model.PermOwner;
import io.swagger.client.model.Permission;
import io.swagger.client.model.PermissionAssignmentInfo;
import io.swagger.client.model.PermissionId;
...
public class Permission {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(accountGrant, accountId, accountName, appDisplayName, appId, appType, arraySize, assignData, assigned, assocBy, attributes, authorizedBy, boundBy, boundable, bounds, causePerms, containedPermsAuthorizable, deleted, description, displayName, dynamic, editable, endDate, entityCategories, link, linkApplication, linkBoundperms, linkHolders, linkOwner, linkPermissions, linkSubperms, mappings, name, owners, permId, permissionAssignment, permissionId, perms, provByPerm, provPerm, requestApprovalPolicy, requestPolicy, risk, selected, startDate, subPerms, totalSearch, type, uniquePermId, userCount, value);
  }
