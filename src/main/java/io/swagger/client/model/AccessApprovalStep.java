...
public class AccessApprovalStep {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(approvalCondition, approvalConditionReq, approverType, approvers, autoApproveAuthItems, autoApproveAuthItemsReq, escalationPeriod, escalatorType, escalators, idmWorkflow, idmWorkflowFailureAction, reminderBccType, reminderBccs, reminderCcType, reminderCcs, reminderFrequency, stepSequence, timeoutAction, timeoutPeriod);
  }
