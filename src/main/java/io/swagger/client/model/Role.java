...
public class Role {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(assigned, assignedCount, attributes, authorizedBy, canEditEntity, canManageEntity, changedBy, cost, createdBy, creationTime, deleted, description, detected, detectionStatus, entityCategories, id, link, name, owners, permissions, requestApprovalPolicy, requestPolicy, risk, riskMode, roleLevelApproval, selected, state, uniquePolicyId, updateTime, userCount);
  }
