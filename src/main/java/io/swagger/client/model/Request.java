...
public class Request {
   ...
   */
  @JsonAdapter(SubmitStatusEnum.Adapter.class)
  public enum SubmitStatusEnum {
    ...
    public static SubmitStatusEnum fromValue(String input) {
      for (SubmitStatusEnum b : SubmitStatusEnum.values()) {
        if (b.value.equals(input)) {
          return b;
        }
      }
    ...
    public static class Adapter extends TypeAdapter<SubmitStatusEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final SubmitStatusEnum enumeration) throws IOException {
        jsonWriter.value(String.valueOf(enumeration.getValue()));
      }

      @Override
      public SubmitStatusEnum read(final JsonReader jsonReader) throws IOException {
        Object value = jsonReader.nextString();
        return SubmitStatusEnum.fromValue((String)(value));
      }
    }
  }  @SerializedName("submitStatus")
  private SubmitStatusEnum submitStatus = null;
  ...
  **/
  ...
  public Request lastSubmit(Boolean lastSubmit) {
  ...
  **/
  ...
  public Request submitStatus(SubmitStatusEnum submitStatus) {
  ...
  **/
  @ApiModelProperty(value = "")
  public SubmitStatusEnum getSubmitStatus() {
    return submitStatus;
  }

  public void setSubmitStatus(SubmitStatusEnum submitStatus) {
    this.submitStatus = submitStatus;
  }

  public Request submittingToWf(Boolean submittingToWf) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.commentRequired, request.commentRequired) &&
        ...
        Objects.equals(this.lastSubmit, request.lastSubmit) &&
        ...
        Objects.equals(this.submitStatus, request.submitStatus) &&
        Objects.equals(this.submittingToWf, request.submittingToWf);
  }

  @Override
  public int hashCode() {
    return Objects.hash(commentRequired, fulfillmentTarget, lastSubmit, reason, requestItems, requestSource, requester, requesterDeleted, requesterDisplayName, submitStatus, submittingToWf);
  }
