...
import io.swagger.client.model.DateCountList;
import io.swagger.client.model.LabelColNameList;
import io.swagger.client.model.PolicyVioStatListNode;
import io.swagger.client.model.Response;
import io.swagger.client.model.TypeCountList;
...
public class DataAnalyticsPolicyviolationsApi {
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call getViolationStatsCall(Long startTime, Long endTime, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getViolationStatsValidateBeforeCall(Long startTime, Long endTime, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        com.squareup.okhttp.Call call = getViolationStatsCall(startTime, endTime, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public PolicyVioStatListNode getViolationStats(Long startTime, Long endTime) throws ApiException {
        ApiResponse<PolicyVioStatListNode> resp = getViolationStatsWithHttpInfo(startTime, endTime);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<PolicyVioStatListNode> getViolationStatsWithHttpInfo(Long startTime, Long endTime) throws ApiException {
        com.squareup.okhttp.Call call = getViolationStatsValidateBeforeCall(startTime, endTime, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getViolationStatsAsync(Long startTime, Long endTime, final ApiCallback<PolicyVioStatListNode> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getViolationStatsValidateBeforeCall(startTime, endTime, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<PolicyVioStatListNode>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
