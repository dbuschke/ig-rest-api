...
public class DataAppsIdPermsApi {
    ...
    /**
     * Build call for updateApplicationPermission
     * @param body - Permission payload (required)
     * @param ID - Application ID (required)
     * @param permId - Permission ID (required)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call updateApplicationPermissionCall(Permission body, Long ID, Long permId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = body;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call updateApplicationPermissionValidateBeforeCall(Permission body, Long ID, Long permId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        // verify the required parameter 'body' is set
        if (body == null) {
            throw new ApiException("Missing the required parameter 'body' when calling updateApplicationPermission(Async)");
        }
        // verify the required parameter 'ID' is set
        if (ID == null) {
            throw new ApiException("Missing the required parameter 'ID' when calling updateApplicationPermission(Async)");
        }
        // verify the required parameter 'permId' is set
        if (permId == null) {
            throw new ApiException("Missing the required parameter 'permId' when calling updateApplicationPermission(Async)");
        }
        
        com.squareup.okhttp.Call call = updateApplicationPermissionCall(body, ID, permId, progressListener, progressRequestListener);
        return call;
    ...
    /**
     * Update the curated attributes for a permission with ID permId associated  with an application having the ID appId
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public Response updateApplicationPermission(Permission body, Long ID, Long permId) throws ApiException {
        ApiResponse<Response> resp = updateApplicationPermissionWithHttpInfo(body, ID, permId);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Response> updateApplicationPermissionWithHttpInfo(Permission body, Long ID, Long permId) throws ApiException {
        com.squareup.okhttp.Call call = updateApplicationPermissionValidateBeforeCall(body, ID, permId, null, null);
        Type localVarReturnType = new TypeToken<Response>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * Update the curated attributes for a permission with ID permId associated  with an application having the ID appId (asynchronously)
     * Accepted Roles: * Application Administrator * Application Owner * Auditor * Customer Administrator * Data Administrator * Fulfillment Administrator * Review Administrator * Security Officer * Separation of Duties Administrator * Technical Roles Administrator 
     * @param body - Permission payload (required)
     * @param ID - Application ID (required)
     * @param permId - Permission ID (required)
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call updateApplicationPermissionAsync(Permission body, Long ID, Long permId, final ApiCallback<Response> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = updateApplicationPermissionValidateBeforeCall(body, ID, permId, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<Response>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
    /**
     * Build call for updateApplicationPermissions
     * @param body - Permission payload (required)
     * @param ID - Application ID (required)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call updateApplicationPermissionsCall(Permission body, Long ID, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = body;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call updateApplicationPermissionsValidateBeforeCall(Permission body, Long ID, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        // verify the required parameter 'body' is set
        if (body == null) {
            throw new ApiException("Missing the required parameter 'body' when calling updateApplicationPermissions(Async)");
        }
        // verify the required parameter 'ID' is set
        if (ID == null) {
            throw new ApiException("Missing the required parameter 'ID' when calling updateApplicationPermissions(Async)");
        }
        
        com.squareup.okhttp.Call call = updateApplicationPermissionsCall(body, ID, progressListener, progressRequestListener);
        return call;
    ...
    /**
     * Update the curated attributes for a permissions in bulk for the  application denoted by appId
     * Accepted Roles: * Access Request Administrator * Application Administrator * Application Owner * Auditor * Business Role Manager * Business Roles Administrator * Customer Administrator * Data Administrator * Review Administrator * Role owner * Security Officer * Separation of Duties Administrator * Technical Roles Administrator 
     * @param body - Permission payload (required)
     * @param ID - Application ID (required)
     * @return Response
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public Response updateApplicationPermissions(Permission body, Long ID) throws ApiException {
        ApiResponse<Response> resp = updateApplicationPermissionsWithHttpInfo(body, ID);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Response> updateApplicationPermissionsWithHttpInfo(Permission body, Long ID) throws ApiException {
        com.squareup.okhttp.Call call = updateApplicationPermissionsValidateBeforeCall(body, ID, null, null);
        Type localVarReturnType = new TypeToken<Response>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * Update the curated attributes for a permissions in bulk for the  application denoted by appId (asynchronously)
     * Accepted Roles: * Access Request Administrator * Application Administrator * Application Owner * Auditor * Business Role Manager * Business Roles Administrator * Customer Administrator * Data Administrator * Review Administrator * Role owner * Security Officer * Separation of Duties Administrator * Technical Roles Administrator 
     * @param body - Permission payload (required)
     * @param ID - Application ID (required)
     * @param callback The callback to be executed when the API call finishes
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call updateApplicationPermissionsAsync(Permission body, Long ID, final ApiCallback<Response> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = updateApplicationPermissionsValidateBeforeCall(body, ID, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<Response>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
