...
public class MaintCleanupApi {
    ...
    private com.squareup.okhttp.Call getNextCleanupEntityInstancesValidateBeforeCall(String entityType, String q, Integer size, String sortBy, String sortOrder, Integer indexFrom, Boolean archivedOnly, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getNextCleanupEntityInstancesCall(entityType, q, size, sortBy, sortOrder, indexFrom, archivedOnly, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public CleanupEntityInstances getNextCleanupEntityInstances(String entityType, String q, Integer size, String sortBy, String sortOrder, Integer indexFrom, Boolean archivedOnly) throws ApiException {
        ApiResponse<CleanupEntityInstances> resp = getNextCleanupEntityInstancesWithHttpInfo(entityType, q, size, sortBy, sortOrder, indexFrom, archivedOnly);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<CleanupEntityInstances> getNextCleanupEntityInstancesWithHttpInfo(String entityType, String q, Integer size, String sortBy, String sortOrder, Integer indexFrom, Boolean archivedOnly) throws ApiException {
        com.squareup.okhttp.Call call = getNextCleanupEntityInstancesValidateBeforeCall(entityType, q, size, sortBy, sortOrder, indexFrom, archivedOnly, null, null);
        Type localVarReturnType = new TypeToken<CleanupEntityInstances>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getNextCleanupEntityInstancesAsync(String entityType, String q, Integer size, String sortBy, String sortOrder, Integer indexFrom, Boolean archivedOnly, final ApiCallback<CleanupEntityInstances> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getNextCleanupEntityInstancesValidateBeforeCall(entityType, q, size, sortBy, sortOrder, indexFrom, archivedOnly, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<CleanupEntityInstances>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call startNextCleanupEntityCountsCall(final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call startNextCleanupEntityCountsValidateBeforeCall(final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        com.squareup.okhttp.Call call = startNextCleanupEntityCountsCall(progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public Status startNextCleanupEntityCounts() throws ApiException {
        ApiResponse<Status> resp = startNextCleanupEntityCountsWithHttpInfo();
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Status> startNextCleanupEntityCountsWithHttpInfo() throws ApiException {
        com.squareup.okhttp.Call call = startNextCleanupEntityCountsValidateBeforeCall(null, null);
        Type localVarReturnType = new TypeToken<Status>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call startNextCleanupEntityCountsAsync(final ApiCallback<Status> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = startNextCleanupEntityCountsValidateBeforeCall(progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<Status>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
