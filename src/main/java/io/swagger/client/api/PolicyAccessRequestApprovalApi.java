...
import io.swagger.client.model.AccessRequestApprovalPolicies;
import io.swagger.client.model.AccessRequestApprovalPolicy;
import io.swagger.client.model.AccessRequestPolicy;
import io.swagger.client.model.AppDataSources;
import io.swagger.client.model.AssignedPolicies;
import io.swagger.client.model.Download;
import io.swagger.client.model.EmailTemplates;
import java.io.File;
import io.swagger.client.model.ModelImport;
import io.swagger.client.model.Permissions;
import io.swagger.client.model.RequestItems;
...
public class PolicyAccessRequestApprovalApi {
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call startDownloadCall(Download body, List<String> attrFilter, Boolean roles, Boolean apps, Boolean _default, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = body;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call startDownloadValidateBeforeCall(Download body, List<String> attrFilter, Boolean roles, Boolean apps, Boolean _default, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        // verify the required parameter 'body' is set
        if (body == null) {
            throw new ApiException("Missing the required parameter 'body' when calling startDownload(Async)");
        }
        
        com.squareup.okhttp.Call call = startDownloadCall(body, attrFilter, roles, apps, _default, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public Response startDownload(Download body, List<String> attrFilter, Boolean roles, Boolean apps, Boolean _default) throws ApiException {
        ApiResponse<Response> resp = startDownloadWithHttpInfo(body, attrFilter, roles, apps, _default);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Response> startDownloadWithHttpInfo(Download body, List<String> attrFilter, Boolean roles, Boolean apps, Boolean _default) throws ApiException {
        com.squareup.okhttp.Call call = startDownloadValidateBeforeCall(body, attrFilter, roles, apps, _default, null, null);
        Type localVarReturnType = new TypeToken<Response>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call startDownloadAsync(Download body, List<String> attrFilter, Boolean roles, Boolean apps, Boolean _default, final ApiCallback<Response> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = startDownloadValidateBeforeCall(body, attrFilter, roles, apps, _default, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<Response>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
