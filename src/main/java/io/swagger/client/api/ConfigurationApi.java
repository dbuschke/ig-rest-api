...
import io.swagger.client.model.AccountCategories;
import io.swagger.client.model.AccountCategory;
...
public class ConfigurationApi {
     ...
     * This returns the reporting  configurations ( configuration properties with prefix com.netiq.iac.rpt).&lt;br/&gt;Accepted Roles: * Customer Administrator 
     * @return Response
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
