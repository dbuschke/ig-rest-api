...
public class ReviewReviewingTargetsApi {
    private ApiClient apiClient;

    public ReviewReviewingTargetsApi() {
        this(Configuration.getDefaultApiClient());
    }

    public ReviewReviewingTargetsApi(ApiClient apiClient) {
    ...
    public com.squareup.okhttp.Call cancelDownloadCall(String id, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        String localVarPath = "/review/reviewingTargets/download/{id}"
    ...
    /**
     * Cancel the download of a CSV file.
    ...
    /**
     * Cancel the download of a CSV file. (asynchronously)
     * Accepted Roles: * Auditor * Customer Administrator * Review Administrator * Review Owner 
     * @param id - The download id to delete (required)
    ...
    /**
     * Build call for getTargetSpecPreview
     * @param body The target specification. (required)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call getTargetSpecPreviewCall(ReviewingTargets body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = body;
        
        // create path and map variables
        String localVarPath = "/review/reviewingTargets";
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getTargetSpecPreviewValidateBeforeCall(ReviewingTargets body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        // verify the required parameter 'body' is set
        if (body == null) {
            throw new ApiException("Missing the required parameter 'body' when calling getTargetSpecPreview(Async)");
        }
        
        com.squareup.okhttp.Call call = getTargetSpecPreviewCall(body, progressListener, progressRequestListener);
        return call;
    ...
    /**
     * Preview the target specification.
     * Accepted Roles: * Auditor * Customer Administrator * Review Administrator * Review Owner 
     * @param body The target specification. (required)
     * @return Response
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public Response getTargetSpecPreview(ReviewingTargets body) throws ApiException {
        ApiResponse<Response> resp = getTargetSpecPreviewWithHttpInfo(body);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Response> getTargetSpecPreviewWithHttpInfo(ReviewingTargets body) throws ApiException {
        com.squareup.okhttp.Call call = getTargetSpecPreviewValidateBeforeCall(body, null, null);
        Type localVarReturnType = new TypeToken<Response>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * Preview the target specification. (asynchronously)
     * Accepted Roles: * Auditor * Customer Administrator * Review Administrator * Review Owner 
     * @param body The target specification. (required)
     * @param callback The callback to be executed when the API call finishes
     * @return The request call
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getTargetSpecPreviewAsync(ReviewingTargets body, final ApiCallback<Response> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getTargetSpecPreviewValidateBeforeCall(body, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<Response>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
    /**
     * Build call for startTargetSpecDownload
     * @param body The target specification. (required)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call startTargetSpecDownloadCall(ReviewingTargets body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = body;
        
        // create path and map variables
        String localVarPath = "/review/reviewingTargets/download";
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call startTargetSpecDownloadValidateBeforeCall(ReviewingTargets body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        // verify the required parameter 'body' is set
        if (body == null) {
            throw new ApiException("Missing the required parameter 'body' when calling startTargetSpecDownload(Async)");
        }
        
        com.squareup.okhttp.Call call = startTargetSpecDownloadCall(body, progressListener, progressRequestListener);
        return call;
    ...
    /**
     * Start download of target criteria CSV
     * Accepted Roles: * Auditor * Customer Administrator * Review Administrator * Review Owner 
     * @param body The target specification. (required)
     * @return Response
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public Response startTargetSpecDownload(ReviewingTargets body) throws ApiException {
        ApiResponse<Response> resp = startTargetSpecDownloadWithHttpInfo(body);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Response> startTargetSpecDownloadWithHttpInfo(ReviewingTargets body) throws ApiException {
        com.squareup.okhttp.Call call = startTargetSpecDownloadValidateBeforeCall(body, null, null);
        Type localVarReturnType = new TypeToken<Response>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * Start download of target criteria CSV (asynchronously)
     * Accepted Roles: * Auditor * Customer Administrator * Review Administrator * Review Owner 
     * @param body The target specification. (required)
     * @param callback The callback to be executed when the API call finishes
     * @return The request call
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call startTargetSpecDownloadAsync(ReviewingTargets body, final ApiCallback<Response> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = startTargetSpecDownloadValidateBeforeCall(body, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<Response>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
    ...
    public com.squareup.okhttp.Call statusDownloadCall(String id, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/review/reviewingTargets/download/{id}/status"
            .replaceAll("\\{" + "id" + "\\}", apiClient.escapeString(id.toString()));
