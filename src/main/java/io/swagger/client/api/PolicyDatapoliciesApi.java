...
public class PolicyDatapoliciesApi {
     ...
     * @param forSchedule - flag to return data policies for schedule, default is false; all others are gnored if this one is true (optional, default to false)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     * @param remediationRunId - if this is included, the remedication run table is used to look up the historical value of dp (optional)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
    ...
    /**
     * Get data policy by specified id or uniqueId
    ...
    /**
     * Get data policy by specified id or uniqueId (asynchronously)
     * Accepted Roles: * Customer Administrator * Data Administrator * Fulfillment Administrator 
     * @param id - data policy id (required)
     * @param uniqueId - data policy unique id (optional)
     * @param remediationRunId - if this is included, the remedication run table is used to look up the historical value of dp (optional)
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call getDataPolicyViolationsCall(Long dpId, Integer size, Integer indexFrom, String q, String qMatch, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getDataPolicyViolationsValidateBeforeCall(Long dpId, Integer size, Integer indexFrom, String q, String qMatch, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        com.squareup.okhttp.Call call = getDataPolicyViolationsCall(dpId, size, indexFrom, q, qMatch, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public Response getDataPolicyViolations(Long dpId, Integer size, Integer indexFrom, String q, String qMatch) throws ApiException {
        ApiResponse<Response> resp = getDataPolicyViolationsWithHttpInfo(dpId, size, indexFrom, q, qMatch);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Response> getDataPolicyViolationsWithHttpInfo(Long dpId, Integer size, Integer indexFrom, String q, String qMatch) throws ApiException {
        com.squareup.okhttp.Call call = getDataPolicyViolationsValidateBeforeCall(dpId, size, indexFrom, q, qMatch, null, null);
        Type localVarReturnType = new TypeToken<Response>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getDataPolicyViolationsAsync(Long dpId, Integer size, Integer indexFrom, String q, String qMatch, final ApiCallback<Response> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getDataPolicyViolationsValidateBeforeCall(dpId, size, indexFrom, q, qMatch, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<Response>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
