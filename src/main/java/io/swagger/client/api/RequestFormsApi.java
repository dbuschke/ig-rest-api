...
import java.io.File;
import io.swagger.client.model.FormsetMapping;
...
public class RequestFormsApi {
     ...
     * @param uniquePermissionId the uniquePermissionId, mutually exclusive with applicationId (optional)
     * @param applicationId the applicationId, mutually exclusive with uniquePermissionId (optional)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call recipientContextCall(String recipientUniqueUserId, String uniquePermissionId, Long applicationId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call recipientContextValidateBeforeCall(String recipientUniqueUserId, String uniquePermissionId, Long applicationId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = recipientContextCall(recipientUniqueUserId, uniquePermissionId, applicationId, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public Response recipientContext(String recipientUniqueUserId, String uniquePermissionId, Long applicationId) throws ApiException {
        ApiResponse<Response> resp = recipientContextWithHttpInfo(recipientUniqueUserId, uniquePermissionId, applicationId);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Response> recipientContextWithHttpInfo(String recipientUniqueUserId, String uniquePermissionId, Long applicationId) throws ApiException {
        com.squareup.okhttp.Call call = recipientContextValidateBeforeCall(recipientUniqueUserId, uniquePermissionId, applicationId, null, null);
        Type localVarReturnType = new TypeToken<Response>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call recipientContextAsync(String recipientUniqueUserId, String uniquePermissionId, Long applicationId, final ApiCallback<Response> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = recipientContextValidateBeforeCall(recipientUniqueUserId, uniquePermissionId, applicationId, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<Response>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
