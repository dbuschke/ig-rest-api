...
import io.swagger.client.model.SystemDataListNode;
...
public class DataUsersApi {
     ...
     * @param body User payload (required)
    ...
    public com.squareup.okhttp.Call updateUserCall(User body, Long userId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/data/users/{userId}"
            .replaceAll("\\{" + "userId" + "\\}", apiClient.escapeString(userId.toString()));
    ...
    /**
     * DEPRECATED in AR2.0 Update the curated attributes for a user with ID userId
    ...
    /**
     * DEPRECATED in AR2.0 Update the curated attributes for a user with ID userId (asynchronously)
     * Accepted Roles: * Customer Administrator * Data Administrator 
     * @param body User payload (required)
     * @param userId User ID (required)
     * @param callback The callback to be executed when the API call finishes
    ...
    /**
     * Build call for updateUserByUniqueUserId
     * @param body User payload (required)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call updateUserByUniqueUserIdCall(User body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = body;
        
        // create path and map variables
        String localVarPath = "/data/users/uniqueId";
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call updateUserByUniqueUserIdValidateBeforeCall(User body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        // verify the required parameter 'body' is set
        if (body == null) {
            throw new ApiException("Missing the required parameter 'body' when calling updateUserByUniqueUserId(Async)");
        }
        
        com.squareup.okhttp.Call call = updateUserByUniqueUserIdCall(body, progressListener, progressRequestListener);
        return call;
    ...
    /**
     * DEPRECATED in AR2.0 Update the curated attributes for a user with the unique user id in the payload
     * Accepted Roles: * Customer Administrator * Data Administrator 
     * @param body User payload (required)
     * @return User
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public User updateUserByUniqueUserId(User body) throws ApiException {
        ApiResponse<User> resp = updateUserByUniqueUserIdWithHttpInfo(body);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<User> updateUserByUniqueUserIdWithHttpInfo(User body) throws ApiException {
        com.squareup.okhttp.Call call = updateUserByUniqueUserIdValidateBeforeCall(body, null, null);
        Type localVarReturnType = new TypeToken<User>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * DEPRECATED in AR2.0 Update the curated attributes for a user with the unique user id in the payload (asynchronously)
     * Accepted Roles: * Customer Administrator * Data Administrator 
     * @param body User payload (required)
     * @param callback The callback to be executed when the API call finishes
     * @return The request call
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call updateUserByUniqueUserIdAsync(User body, final ApiCallback<User> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = updateUserByUniqueUserIdValidateBeforeCall(body, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<User>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
