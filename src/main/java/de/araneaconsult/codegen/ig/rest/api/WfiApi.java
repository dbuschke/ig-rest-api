...
import de.araneaconsult.codegen.ig.rest.model.Approval;
import de.araneaconsult.codegen.ig.rest.model.Associations;
import de.araneaconsult.codegen.ig.rest.model.Delegate;
import de.araneaconsult.codegen.ig.rest.model.Entities;
...
import de.araneaconsult.codegen.ig.rest.model.UserEmailNode;
import de.araneaconsult.codegen.ig.rest.model.UserInfo;
import de.araneaconsult.codegen.ig.rest.model.Whoami;
...
public class WfiApi {
     ...
     * Note the entites nodes are just minimal, with entityType, name, description, and id.&lt;br/&gt;Accepted Roles: * Bootstrap Admin 
     * @param id the association id (optional)
     * @param type the assocation type (Only ApprovalPolicy is currently supported) (optional)
     * @param indexFrom the starting row (optional, default to 0)
     * @param size the size of result set (optional, default to 0)
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public Entities getWorkflowAssociationDetails(String id, String type, Integer indexFrom, Integer size, String q) throws ApiException {
        ApiResponse<Entities> resp = getWorkflowAssociationDetailsWithHttpInfo(id, type, indexFrom, size, q);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Entities> getWorkflowAssociationDetailsWithHttpInfo(String id, String type, Integer indexFrom, Integer size, String q) throws ApiException {
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getWorkflowAssociationDetailsAsync(String id, String type, Integer indexFrom, Integer size, String q, final ApiCallback<Entities> callback) throws ApiException {
