...
import de.araneaconsult.codegen.ig.rest.model.Reviewassignment;
...
public class ReviewInstancesApi {
     ...
     * @param id review instance id (required)
     * @param itemId review item action id (required)
     * @param type item type. Currently, we only support permission (optional)
     ...
     * @param showCt Show count of available entities, default is false (optional, default to false)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
