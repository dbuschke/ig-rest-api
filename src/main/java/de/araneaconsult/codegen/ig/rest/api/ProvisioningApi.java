...
import de.araneaconsult.codegen.ig.rest.model.ChangeItem;
import de.araneaconsult.codegen.ig.rest.model.ChangeItemList;
import de.araneaconsult.codegen.ig.rest.model.Changeset;
import de.araneaconsult.codegen.ig.rest.model.ConfigurationTarget;
...
import de.araneaconsult.codegen.ig.rest.model.ProvisionItems;
import de.araneaconsult.codegen.ig.rest.model.Requests;
...
public class ProvisioningApi {
     ...
     * @param sortBy the filter to sort the results on, possible values are \&quot;userName\&quot;,\&quot;permName\&quot;,\&quot;appName\&quot;,\&quot;action\&quot;,\&quot;fulfillerName\&quot;,\&quot;acctName\&quot;,change_request_item\&quot; (optional)
    ...
    /**
     * Start auto-provisioning for all the items in the changeset (Deprecated).
     * Deprecated, this API call will be removed in a future release.  This is a legacy API call that was used before changeset processing was done internally, and as such it is no longer required nor supported.  &lt;p&gt;  &lt;br/&gt;&lt;strong&gt;Note: This was used by the internal workflow engine, which has been replaced by internal code&lt;/strong&gt;&lt;br/&gt;  &lt;/p&gt;&lt;br/&gt;Accepted Roles: * Customer Administrator * Fulfillment Administrator 
     * @param cid - the changeset id (required)
     * @return Response
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    ...
    /**
     * Start auto-provisioning for all the items in the changeset (Deprecated). (asynchronously)
     * Deprecated, this API call will be removed in a future release.  This is a legacy API call that was used before changeset processing was done internally, and as such it is no longer required nor supported.  &lt;p&gt;  &lt;br/&gt;&lt;strong&gt;Note: This was used by the internal workflow engine, which has been replaced by internal code&lt;/strong&gt;&lt;br/&gt;  &lt;/p&gt;&lt;br/&gt;Accepted Roles: * Customer Administrator * Fulfillment Administrator 
     * @param cid - the changeset id (required)
     * @param callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     * Note the payload for a fulfillment target is complex and is not documented fully here.  In cases like this, one could run Identity Governance in a browser with developer tools enabled and watch the network traffic between the browser and the server to view particulars about the REST payloads.&lt;br/&gt;Accepted Roles: * Customer Administrator * Fulfillment Administrator 
     * @param body the fulfillment target configuration payload (required)
     * @param targetId the fulfillment target id (required)
     * @return Response
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
