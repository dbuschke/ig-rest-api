...
import de.araneaconsult.codegen.ig.rest.model.AdvisorFeed;
...
public class DcsAdvisorfeedsApi {
     ...
     * @param id the ID of the AdvisorFeed record (required)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call startBulkUpdateCall(File uploadedInputStream, Long id, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call startBulkUpdateValidateBeforeCall(File uploadedInputStream, Long id, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling startBulkUpdate(Async)");
        }
        
        com.squareup.okhttp.Call call = startBulkUpdateCall(uploadedInputStream, id, progressListener, progressRequestListener);
        return call;
    ...
    /**
     * Perform an upload of bulk load CSV file
     * Accepted Roles: * Customer Administrator * Data Administrator 
     * @param uploadedInputStream  (required)
     * @param id the ID of the AdvisorFeed record (required)
     * @return Response
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public Response startBulkUpdate(File uploadedInputStream, Long id) throws ApiException {
        ApiResponse<Response> resp = startBulkUpdateWithHttpInfo(uploadedInputStream, id);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Response> startBulkUpdateWithHttpInfo(File uploadedInputStream, Long id) throws ApiException {
        com.squareup.okhttp.Call call = startBulkUpdateValidateBeforeCall(uploadedInputStream, id, null, null);
        Type localVarReturnType = new TypeToken<Response>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * Perform an upload of bulk load CSV file (asynchronously)
     * Accepted Roles: * Customer Administrator * Data Administrator 
     * @param uploadedInputStream  (required)
     * @param id the ID of the AdvisorFeed record (required)
     * @param callback The callback to be executed when the API call finishes
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call startBulkUpdateAsync(File uploadedInputStream, Long id, final ApiCallback<Response> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = startBulkUpdateValidateBeforeCall(uploadedInputStream, id, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<Response>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
