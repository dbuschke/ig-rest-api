...
import de.araneaconsult.codegen.ig.rest.model.Emailrecipient;
import de.araneaconsult.codegen.ig.rest.model.ReviewInst;
...
public class RemediationRunNode {
  ...
  private List<Emailrecipient> emailTo = null;
  ...
  **/
  ...
  public RemediationRunNode emailTo(List<Emailrecipient> emailTo) {
    this.emailTo = emailTo;
    return this;
  }

  public RemediationRunNode addEmailToItem(Emailrecipient emailToItem) {
    if (this.emailTo == null) {
      this.emailTo = new ArrayList<Emailrecipient>();
    }
  ...
  **/
  @ApiModelProperty(value = "")
  public List<Emailrecipient> getEmailTo() {
    return emailTo;
  }

  public void setEmailTo(List<Emailrecipient> emailTo) {
    this.emailTo = emailTo;
  }
