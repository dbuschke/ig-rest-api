...
public class DataAppsIdAccountsApi {
     ...
     * @param q - Quick search filter value (optional)
     * @param qMatch - match mode, how to compare value to quick search string         allowable values: START, ANY, EXACT, where EXACT &#x3D; exact match,         ANY &#x3D; match any place in string, START &#x3D; match on starting         character (optional, default to ANY)
     * @param getAssignments - Flag indicating whether to get assignment information for each permission. (optional, default to false)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call getAccountPermissionsCall(Long accId, Long ID, List<String> listAttr, String sortBy, String sortOrder, Integer indexFrom, Integer size, Boolean showCt, String q, String qMatch, Boolean getAssignments, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
        ...
        localVarQueryParams.addAll(apiClient.parameterToPair("getAssignments", getAssignments));
    ...
    private com.squareup.okhttp.Call getAccountPermissionsValidateBeforeCall(Long accId, Long ID, List<String> listAttr, String sortBy, String sortOrder, Integer indexFrom, Integer size, Boolean showCt, String q, String qMatch, Boolean getAssignments, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getAccountPermissionsCall(accId, ID, listAttr, sortBy, sortOrder, indexFrom, size, showCt, q, qMatch, getAssignments, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public Response getAccountPermissions(Long accId, Long ID, List<String> listAttr, String sortBy, String sortOrder, Integer indexFrom, Integer size, Boolean showCt, String q, String qMatch, Boolean getAssignments) throws ApiException {
        ApiResponse<Response> resp = getAccountPermissionsWithHttpInfo(accId, ID, listAttr, sortBy, sortOrder, indexFrom, size, showCt, q, qMatch, getAssignments);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Response> getAccountPermissionsWithHttpInfo(Long accId, Long ID, List<String> listAttr, String sortBy, String sortOrder, Integer indexFrom, Integer size, Boolean showCt, String q, String qMatch, Boolean getAssignments) throws ApiException {
        com.squareup.okhttp.Call call = getAccountPermissionsValidateBeforeCall(accId, ID, listAttr, sortBy, sortOrder, indexFrom, size, showCt, q, qMatch, getAssignments, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getAccountPermissionsAsync(Long accId, Long ID, List<String> listAttr, String sortBy, String sortOrder, Integer indexFrom, Integer size, Boolean showCt, String q, String qMatch, Boolean getAssignments, final ApiCallback<Response> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getAccountPermissionsValidateBeforeCall(accId, ID, listAttr, sortBy, sortOrder, indexFrom, size, showCt, q, qMatch, getAssignments, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<Response>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
