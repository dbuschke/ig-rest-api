...
import de.araneaconsult.codegen.ig.rest.model.EnterMaintProgress;
...
public class MaintState {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(archiveDisableEnable, canResumeLastArchive, disableEnableStatus, enteringMaintProgress, executionMode, lastArchiveState, runningArchival, runningCleanup, waitState);
  }
